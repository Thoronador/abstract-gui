...
#ifndef ABSGUI_WINDOW_H
#define ABSGUI_WINDOW_H
...
class Window
{
  public:
    ...
    */
    Window(const int width, const int height, const int left, const int top, const std::string& title);
    ...
    */
    virtual void setDimensions(const int width, const int height) = 0;
    ...
    */
    virtual void writeText(const std::string& text, const float x, const float y, const float z) = 0;
