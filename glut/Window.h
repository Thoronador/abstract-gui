...
#ifndef ABSGUI_GLUTWINDOW_H
#define ABSGUI_GLUTWINDOW_H
...
class glutWindow: public Window
{
  public:
    ...
    */
    glutWindow(const int width, const int height, const int left, const int top, const std::string& title);
